...
Happens when you download files from the internet and Apple assumes they're
dangerous. **Don't use this blindly!**
...
Just shaved off 40GB of space by removing cache of Adobe After Effects. I've
uninstalled it 5 months ago and it never occured to me that it would hog that
much "temporary" space. Run `ncdu` at least once a year!

#### Delete key (not backspace!)

Feel really dumb about this one :) I assumed that there's no built-in "delete
key" functionality in macOs, as the "Delete" key wasn't present on Mac keyboard.
Lo and behold, Fn+Backspace works as the Delete key!

#### Web browsing

[Orion Browser](https://kagi.com/orion/) by [Kagi](https://kagi.com).
...
The rest of this post documents my 7-day journey in converting to MacOS as a
Linux power-user.
